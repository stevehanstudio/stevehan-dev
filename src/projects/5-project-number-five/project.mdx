---
title: Dopamine VR Podcast
slug: dopamine-vr
image: ./images/html-1.png
date: 2020-05-02
author: Steve Han
skills: ["Javascript","React","Gatsby","Wordpress"]
website: www.dopaminevr.com

---

import { Link } from "gatsby"

This project was redesign using Gatsby / React and Wordpress as a headline CMS.

This website was originally made using Wordpress.
